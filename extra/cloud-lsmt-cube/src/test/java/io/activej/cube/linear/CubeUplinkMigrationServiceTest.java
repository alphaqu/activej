...
public final class CubeUplinkMigrationServiceTest {
								...
								CubeDiff.of(
										mapOf(
												"campaign", AggregationDiff.of(setOf(
														AggregationChunk.create(1L, listOf("clicks", "impressions"), PrimaryKey.ofArray(12), PrimaryKey.ofArray(34), 10),
														AggregationChunk.create(2L, listOf("impressions"), PrimaryKey.ofArray(123), PrimaryKey.ofArray(345), 20)
												)),
												"advertiser-campaign", AggregationDiff.of(setOf(
														AggregationChunk.create(3L, listOf("clicks", "impressions", "revenue"), PrimaryKey.ofArray(15, 654), PrimaryKey.ofArray(35, 76763), 1234),
														AggregationChunk.create(4L, listOf("conversions"), PrimaryKey.ofArray(12, 23), PrimaryKey.ofArray(124, 543), 22)
												))
										)
								)
						)
								...
								CubeDiff.of(
										mapOf(
												"campaign", AggregationDiff.of(
														setOf(
																AggregationChunk.create(5L, listOf("clicks"), PrimaryKey.ofArray(12453), PrimaryKey.ofArray(12453121), 23523),
																AggregationChunk.create(6L, listOf("impressions", "clicks", "conversions", "revenue"), PrimaryKey.ofArray(1113), PrimaryKey.ofArray(34512412), 52350)
														),
														setOf(AggregationChunk.create(1L, listOf("clicks", "impressions"), PrimaryKey.ofArray(12), PrimaryKey.ofArray(34), 10))),
												"advertiser-campaign", AggregationDiff.of(setOf(
														AggregationChunk.create(7L, listOf("clicks", "revenue"), PrimaryKey.ofArray(1125, 53), PrimaryKey.ofArray(1422142, 653), 122134),
														AggregationChunk.create(8L, listOf("conversions", "impressions"), PrimaryKey.ofArray(44, 52), PrimaryKey.ofArray(124124, 122), 65472)
												))
										)
								)
						)
	...
	private void push(List<LogDiff<CubeDiff>> diffs) {
		OTCommit<Long, LogDiff<CubeDiff>> parent = await(repo.loadCommit(Utils.first(await(repo.getHeads()))));
